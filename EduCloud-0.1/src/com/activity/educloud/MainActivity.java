...
//				Toast.makeText(this, "很抱歉，你所在网络不是教育网", Toast.LENGTH_LONG).show();
			}
	...
	public void onClick(View v) {
		//提示框
		Toast.makeText(MainActivity.this, "很抱歉，你所在网络不是教育网", Toast.LENGTH_LONG).show();
	}
	};
